...
fn small_width_long_folder_name () {
    ...
    let (terminal_events, terminal_draw_events, backend) = test_backend_factory(50, 50);
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("small_width_long_folder_name").expect("failed to create temp dir");
...
fn too_small_width_one () {
    ...
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("too_small_width_one").expect("failed to create temp dir");
...
fn too_small_width_two () {
    ...
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("too_small_width_two").expect("failed to create temp dir");
...
fn too_small_width_three () {
    ...
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("too_small_width_three").expect("failed to create temp dir");
...
fn too_small_width_four () {
    ...
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("too_small_width_four").expect("failed to create temp dir");
...
fn too_small_width_five () {
    ...
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("too_small_width_five").expect("failed to create temp dir");
...
fn too_small_height () {
    ...
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("too_small_height").expect("failed to create temp dir");
...
fn enter_folder_medium_width () {
    ...
    let temp_dir_path = create_root_temp_dir("enter_folder_medium_width").expect("failed to create temp dir");
...
fn enter_folder_small_width () {
    ...
    let temp_dir_path = create_root_temp_dir("enter_folder_small_width").expect("failed to create temp dir");
...
fn noop_when_pressing_esc_at_base_folder() {
   ...
   let expected_terminal_events = vec![Clear, HideCursor, Draw, Flush, Draw, Flush, Draw, Flush, Draw, Flush, Draw, Flush, Draw, Flush, Draw, Flush, Draw, Flush, Draw, Flush, Draw, Flush, Draw, Flush, Draw, Flush, Clear, ShowCursor];
   ...
   assert_eq!(terminal_draw_events_mirror.len(), 12);
   assert_snapshot!(&terminal_draw_events_mirror[0]);
   assert_snapshot!(&terminal_draw_events_mirror[1]);
   assert_snapshot!(&terminal_draw_events_mirror[2]);
   assert_snapshot!(&terminal_draw_events_mirror[3]);
...
fn files_with_size_zero() {
    ...
    let (terminal_events, terminal_draw_events, backend) = test_backend_factory(190, 50);
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("files_with_size_zero").expect("failed to create temp dir");
...
fn small_files_with_y_as_zero() {
    ...
    let (terminal_events, terminal_draw_events, backend) = test_backend_factory(190, 50);
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("small_files_with_y_as_zero").expect("failed to create temp dir");
...
fn small_files_with_x_as_zero() {
    ...
    let (terminal_events, terminal_draw_events, backend) = test_backend_factory(50, 50);
    let keyboard_events = sleep_and_quit_events(1);
    let temp_dir_path = create_root_temp_dir("small_files_with_x_as_zero").expect("failed to create temp dir");
